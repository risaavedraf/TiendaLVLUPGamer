...
function CarritoPage() {
  ...
  const [appliedDiscount, setAppliedDiscount] = useState<DescuentoAplicado | null>(null);

  const subtotal = cartDetails.reduce((sum, item) => sum + (item.precio * item.cantidad), 0);
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-md-5">
                        ...
                        <p className="text-muted mb-1 small">
                          {item.descripcion ? item.descripcion.substring(0, 70) + '...' : 'Sin descripción'}
                        </p>
                        <button 
                      ...
                      <div className="col-md-2 text-end">
                        <h5 className="mb-0">${(item.cantidad * item.precio).toFixed(2)}</h5>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <ul className="list-group list-group-flush">
                  ...
                  <li className="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Total</strong>
                    <strong><span>${totalFinal.toFixed(2)}</span></strong>
                  </li>
                </ul>
